...
class AreaCheckServlet: HttpServlet() {
    ...
    private fun checkSuccess(x: Int, y: Double, r: Double): Boolean{
    ...
    private fun validateData(x: Int, y: Double, R: Double): Boolean{
        return (x in (-3..5)) && (y in (-5.0..5.0)) && (R in (1.0..3.0))
    }
